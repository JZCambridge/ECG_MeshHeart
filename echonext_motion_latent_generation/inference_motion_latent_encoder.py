...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_path",
        type=str,
        default='jzheng12/Codes/ECG_MeshHeart/output/echonext_motion_latent_generation/checkpoints_20260113_173551/checkpoint_epoch_40.ckpt',
        help="Path to trained Encoder model checkpoint (.ckpt file)",
    )
    parser.add_argument(
        "--output_path",
        type=str,
        default='ukb/jz_meshheart/feature_calculation/FM_frame_MH_lvef_nofinet_070126/lvef_echo_ep40_140126/raw_info/echonext_latent.csv',
