...
# -*-coding:utf-8 -*-
"""
ECG Binary Disease Prediction Training Script
...
Author: Adapted from echonext_motion_latent_generation
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--label_column",
        type=str,
        default="lv_ef_fr0_percent", #'wt_max', #'lv_ef_fr0_percent', #"diseased",
    ...
    args.checkpoint_dir = args.checkpoint_dir +  args.output_prefix + args.label_column + '_' +args.threshold_direction + str(args.threshold) + '_' + dt_string
