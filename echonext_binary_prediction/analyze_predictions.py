...
Examples:
  ...
  python analyze_predictions.py --batch_mode \\
    ...
    parser.add_argument(
        ...
        type=str,
        default=[
                'jzheng12/Codes/ECG_MeshHeart/output/echonext_binary_prediction/allbatches_lv_ef_fr0_percent_less_than45_20260117_105326/val_predictions_valauc.csv',
                'jzheng12/Codes/ECG_MeshHeart/output/echonext_binary_prediction/allbatches_lv_ef_fr0_percent_less_than50_20260116_170649/val_predictions_valauc.csv',
                'jzheng12/Codes/ECG_MeshHeart/output/echonext_binary_prediction/allbatches_LVEDVi_ml_m2_greater_than61_Sex0_20260116_174424/val_predictions_valauc.csv',
                'jzheng12/Codes/ECG_MeshHeart/output/echonext_binary_prediction/allbatches_LVEDVi_ml_m2_greater_than74_Sex1_20260116_174719/val_predictions_valauc.csv',
                'jzheng12/Codes/ECG_MeshHeart/output/echonext_binary_prediction/allbatches_wt_max_greater_than13_20260117_104920/val_predictions_valauc.csv',
                'jzheng12/Codes/ECG_MeshHeart/output/echonext_binary_prediction/allbatches_wt_max_greater_than15_20260117_100729/val_predictions_valauc.csv'
                ],
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default='ukb/jz_ecg/ecg_echonext_binaryprediction_23Jan26/prediction_analysis',
